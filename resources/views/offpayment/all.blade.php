                ...
                <div class="content">
                    ...
                    <input type="submit" class="btn btn-success form-control" value="Go">
                        ...
                        <table class="table datatable-basic" id="datatable">
                            ...
                            $data=\Illuminate\Support\Facades\DB::table('off_paid_lga')->where('pay_record_id',$payment->id)->first();
                           ...
                           @endif
                            ...
                            <td> {{ \Illuminate\Support\Facades\DB::table('off_pay_clients')->where('pay_id',$payment->id)->count()  }} </td>
                            <td>{{ \Illuminate\Support\Facades\DB::table('off_pay_clients')->where('pay_id',$payment->id)->sum('total')  }}</td>
                            ...
                            <a href="{{ route('offpaid.clients',$payment->id) }}" class="btn btn-danger"> Confirm </a>
                            ...
                            <td> <a class="btn btn-warning" href="off_pay_clients/{{ $payment->id }}"> Clients</a> </td>
