                   ...
                   <div class="page-header">
                    <div class="page-header-content">
                        <div class="page-title">
                            <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Make Off Payment</span></h4>

                        <div class="heading-elements">
                           <a href="{{ url('howitworks') }}" class="btn bg-brown btn-labeled heading-btn"><b><i class="icon-arrow-left15"></i></b> Back</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="content">
                  ...
                  <!-- Wizard with validation -->
                    <div class="panel panel-white">
                        ...
                        <form class="steps-validation" id="form" action="{{ url('offpayment/offpayrecordsave') }}" method="post" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <h6>LGA</h6>
                            <fieldset>
                               <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>LGA<span class="text-danger">*</span></label>
                                             {!! Form::select('lga',[''=>'Select LGA'], old('lga'), ['class'=>'form-control required','required','id'=>'lga']) !!}
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Category<span class="text-danger">*</span></label>
                                             {!! Form::select('category',[''=>'Select Category'] + CommonClass::geCategory(), old('category'), ['class'=>'form-control required','required','id'=>'category','onchange'=>'lgaby()']) !!}
                                        </div>
                                    </div>
                                </div>
                                {{--<div class="row">--}}
...
@push('footerscript')
    ...
    function byward(){
        ...
        $.ajax({
            url: '{{ url('offpayment/offGetPayList') }}',
            type: 'get',
            data:{'lga_id':lga_id,'category':category},
            success:function(data){
