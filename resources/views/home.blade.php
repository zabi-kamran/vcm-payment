 ...
 <!-- Main content -->
            <div class="content-wrapper">
               ...
               <h2>
                ...
                <td>
                <a class="btn btn-primary" href="https://vcm.azurewebsites.net/payment/create"> Add new Record </a>
                </td>
                ...
                <td>
                <a class="btn btn-danger" href="https://vcm.azurewebsites.net/payment"> Payment Management  </a>
                </td>
                ...
                <a class="btn btn-success" href="https://vcm.azurewebsites.net/payment/payrecord"> Process Payment </a>
                </td>
                ...
                <td> <a class="btn" style="background-color:grey;color:white;" href="https://vcm.azurewebsites.net/payments/all"> Search Payment   </a></td>
...
The last part is for weekly communication updates prepared by Data Consultants to
                ...
                <td> <a  class="btn" style="background-color:purple;color:white;" href="https://vcm.azurewebsites.net/weekly/reports/create"> Create Report </a> </td>
                ...
                <td> <a class="btn" style="background-color:purple;color:white;"  href="https://vcm.azurewebsites.net/weekly/reports/view"> View Reports </a> </td>
